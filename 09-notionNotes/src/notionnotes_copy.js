...
import { Book, MessageSquare, Send, FileText } from 'lucide-react';
            ...
            {selectedTemplate && (
              <div>
                ...
                <div className="mt-8 mb-6">
                  ...
                  <textarea
                    className="content-notes w-full min-h-40 p-4 border border-gray-300 rounded bg-gray-50 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
